...
def plot_scores(y, window_size=10, sigmas=2):
    # generate the rolling average of x:
    y_rolling = p.Series(y).rolling(window=window_size, min_periods=10)
    ...
    ax.plot(x, y, label='signal mean', color='tab:purple', alpha=0.1)
